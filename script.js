...
function equation(symbol){
    if(lastCalled != "equal" && operatorBefore !=0){
        if((lastSymbol == "multiply" && curentOperator == 0 || lastSymbol == "division" && curentOperator == 0) && inputZero == false){
            curentOperator = 1;
            equal();
            console.log(curentOperator, lastSymbol,"1");
        }else if(lastSymbol == "multiply-negat" && (curentOperator == 0 && inputZero == false)){
            curentOperator = -1;
            equal();
